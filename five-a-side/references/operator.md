...
- **No signal.** A scheduled job with no dead-man's-switch — "didn't run", "was cancelled", "produced nothing" are invisible without one, a silent outage lasting days usually starts exactly there. A new failure path with no log, no alert, no metric.
