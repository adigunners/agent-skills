...
- **Cite the incident where there is one.** A rule that carries "we lost nine days of data to this" gets weighted correctly by the reviewer and survives the next person who wants to delete it.
